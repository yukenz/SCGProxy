...
public class GlobalRequestLoggingFilter implements GlobalFilter, Ordered {
    ...
    public Mono<Void> filter(ServerWebExchange exchange, GatewayFilterChain chain) {
        ...
        // Decorator
        ServerHttpRequest decoratedRequest = loggingDecoratedRequest(request);
        ServerHttpResponseDecorator decoratedResponse = loggingDecoratedResponse(response, request);
    ...
    private ServerHttpResponseDecorator loggingDecoratedResponse(
                ...
                if (body instanceof Flux) {
                    ...
                    Flux<DataBuffer> newBuffer = fluxBody.buffer()
                            .map(dataBuffers -> {
                                ...
                                DefaultDataBuffer joinedBuffers = defaultDataBufferFactory
                                        .join(dataBuffers);
    ...
    private ServerHttpRequest loggingDecoratedRequest(
            ServerHttpRequest request
    ) {
